...
DIR=chroot
PREINSTALL_PKGS=openssh-server,curl,tar,gcc,vim,mpich,git,htop,fish,tcpdump,iperf,build-essential,redis-server,redis,libc6-dev,time,strace,sudo,less,psmisc,selinux-utils,policycoreutils,checkpolicy,selinux-policy-default,firmware-atheros,debian-ports-archive-keyring
