...
DIR=chroot
PREINSTALL_PKGS=openssh-server,curl,tar,libjpeg62,git,libgles2-mesa,gcc,libegl-dev,vim,htop,fish,tcpdump,iperf,build-essential,redis-server,redis,libc6-dev,time,strace,sudo,less,psmisc,selinux-utils,policycoreutils,checkpolicy,selinux-policy-default,firmware-atheros,debian-ports-archive-keyring
...
sudo cp -r ../apps/stress-ng $DIR/root/stress-ng
