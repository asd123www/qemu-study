...
echo "migrate_set_parameter max-postcopy-bandwidth 1342177280" | socat stdio unix-connect:"$MONITOR_SOCKET"
echo "migrate_set_parameter max-bandwidth 1342177280" | socat stdio unix-connect:"$MONITOR_SOCKET"
